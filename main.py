...
@app.route("/firstmovie")
def firstmovie():
    suggestions = get_suggestions()
    return render_template('firstmovie.html', suggestions=suggestions)
...
@app.route("/movieNameRec",methods=["POST"])
def movieNameRec():
    ...
    return render_template('movieNameRec.html',title=title,poster=poster,overview=overview,vote_average=vote_average,
